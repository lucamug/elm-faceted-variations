        ...
        InitialiseVariants time ->
            case model.payload of
                ...
                Just payload ->
                    let
                        _ =
                            Debug.log "after" (prepareVariantValues2 payload.variants)
...
prepareVariantValues2 : List Variant -> List (List ( String, Int ))
prepareVariantValues2 variants =
    List.indexedMap
        (\index variant ->
            variant.variantValues
                |> listToListOfList
...
transform2 : String -> List a -> List ( a, String )
transform2 id list =
